...
// Not exported, we use engine system within engine.
b8 event_initialize();
void event_shutdown();

// We don't want directly reference to a listener or a sender.
// So function pointer is suitable.
...
// System internal event codes. Application should use codes beyond 0xFF.
typedef enum system_event_code
{
    ...
    */
    EVENT_CODE_BUTTON_MOVED = 0x06,

    // Better to use signed integer?
    // Mouse wheel.
    /**
     * Context usage:
