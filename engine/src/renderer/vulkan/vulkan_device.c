...
b8 physical_device_meets_requirements(
    ...
    vulkan_physical_device_requirements const* requirements,
    vulkan_physical_device_queue_family_info* out_queue_family_info,
    vulkan_swapchain_support_info* out_swapchain_support);

b8 vulkan_device_create(vulkan_context* context)
{
    // We select a physical device, not create a physical device.
    ...
    char const* extension_names = VK_KHR_SWAPCHAIN_EXTENSION_NAME;  // Note: As same as requirment extensions
    ...
    vkGetDeviceQueue(
        ...
        0,  // Within this family, what queue are we requesting, Note: hard code for now.
...
b8 select_physical_device(vulkan_context* context)
{
    ...
    for (u32 i = 0; i < physical_device_count; ++i)
    {
        ...
        // requirements.comput = TRUE;
        requirements.sampler_anisotropy = TRUE;
        requirements.discrete_gpu = TRUE;
        requirements.device_extension_names = darray_create(char const*);
    ...
    {
        KERROR("No Physical device was found which meet the requirements.");
        return FALSE;
    }
...
b8 physical_device_meets_requirements(
    ...
    vulkan_swapchain_support_info* out_swapchain_support)
{
    // Evaluate device properties to determine if it meets
    ...
    KINFO("Graohics | Present | Compute | Transfer | Name");
