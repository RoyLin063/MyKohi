...
// Does not really release resource. Just give back to command pool
...
/**
 * Ends recording, submits to and waits for queue operation and frees provided command buffer.
*/
